        ...
        < React.Fragment className="App">
          ...
          {/* <Router>   
            ...
            <Route exact path={'/newyork'} render={(routerProps)=>(
              <CityPage city={'New York'} introImage='https://res.cloudinary.com/dorsia/image/upload/w_1620/optimized/web_assets/illustrations/new-york.png'
            ...
            <Route exact path={'/sanfrancisco'} render={(routerProps)=>(
              <CityPage city={'San Francisco'} introImage='https://res.cloudinary.com/dorsia/image/upload/w_1620/optimized/web_assets/illustrations/san-francisco.png'
            ...
            <Route exact path={'/losangeles'} render={(routerProps)=>(
              <CityPage city={'Los Angeles'} introImage='https://res.cloudinary.com/dorsia/image/upload/w_1620/optimized/web_assets/illustrations/los-angeles.png'
