...
class TextCardList extends Component {
    state={
        cities:{
                 1:{id:1, name:"Seattle", image:"https://res.cloudinary.com/dorsia/image/upload/w_900/optimized/web_assets/illustrations/seattle", description:"The lush green land of Sub Pop, tech giants and the infamous Seattle Freeze. Yes, it rains here."},
                 2:{id:2, name:"New York", image:"https://res.cloudinary.com/dorsia/image/upload/w_900/optimized/web_assets/illustrations/new-york", description:"Bring your best RBF for those crowded subway rides. Slow walking are not welcome here."},
